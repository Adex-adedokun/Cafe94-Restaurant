...
public class MainScreenController implements Initializable {
    ...
    @FXML private ImageView managerPageLogo;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        managerPageLogo.setImage(logoImg);
    }
    ...
    private void onAddCustomerPressButton(final ActionEvent event)throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/cafe94/signUpScreen.fxml"));
     ...
     */
    private ObservableList<User> getUserList(ResultSet rs) throws SQLException {
    ...
    public void onResfreshButtonPush() throws SQLException {
        ...
        rsQueryBooking = pstBooking.executeQuery();
          ...
          int itemTimes=0;
         if (rsQueryItem.next()) {
             item = rsQueryItem.getString(1);
             itemTimes = rsQueryItem.getInt(2);
            } 
      
          String customer ="";
           int customerTimes =0;
        if (rsQueryCustomer.next()) {
           customer = rsQueryCustomer.getString(1);
           customerTimes = rsQueryCustomer.getInt(2);
            } 
       
        String time = "";
        int timeTimes = 0;
        if (rsQueryBooking.next()) {
             time = rsQueryBooking.getString(1);
            timeTimes = rsQueryBooking.getInt(2);
            } 
