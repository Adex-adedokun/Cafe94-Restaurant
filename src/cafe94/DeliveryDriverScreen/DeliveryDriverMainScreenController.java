package cafe94.DeliveryDriverScreen;
...
public class DeliveryDriverMainScreenController {
    ...
    @FXML private ImageView deliveryDPageLogo;
    ...
    public void initialize() throws IOException, SQLException {
        ...
        deliveryDPageLogo.setImage(img);

        int currentDriver = cafe94.UserDetails.getInstance().getUserID();
