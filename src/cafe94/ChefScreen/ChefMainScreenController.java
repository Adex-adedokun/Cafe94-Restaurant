...
public class ChefMainScreenController {
    ...
    @FXML
    private ComboBox<Item> dailyList;
    @FXML
    private ComboBox<Item> starterList;
    @FXML
    private ComboBox<Item> mainList;
    @FXML
    private ComboBox<Item> sideList;
    @FXML
    private ComboBox<Item> dessertList;
    @FXML
    private ComboBox<Item> drinkList;
    @FXML
    private Button refreshButton;
    @FXML
    private Button completedButton;
    @FXML
    private TableView<Order> chefOrderView;
    @FXML
    ...
    @FXML
    private ImageView chefPageLogo;
    ...
    public void initialize() throws SQLException {
        File file = new File("img/cafe944.png");
        Image img = new Image(file.toURI().toString());
        chefPageLogo.setImage(img);
