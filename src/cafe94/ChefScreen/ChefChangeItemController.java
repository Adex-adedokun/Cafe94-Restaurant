...
public class ChefChangeItemController {
    ...
    @FXML
    private Label itemIDEmptyError;
    @FXML
    private Label itemNameEmptyError;
    @FXML
    private Label itemPriceError;
    @FXML
    private Label successLabel;
    @FXML
    private Label validIDError;
    ...
    public void returnButtonPushed(final ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("/cafe94/ChefScreen/chefMainScreen.fxml"));
