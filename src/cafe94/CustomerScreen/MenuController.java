...
public class MenuController {
    ...
    public void placeTakeawayOrderButtonPushed(final ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("/cafe94/CustomerScreen/TakeawayOrder.fxml"));
    ...
    public void placeDeliveryOrderButtonPushed(final ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("/cafe94/CustomerScreen/DeliveryOrder.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
