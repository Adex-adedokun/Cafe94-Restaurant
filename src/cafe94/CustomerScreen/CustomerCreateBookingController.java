...
public class CustomerCreateBookingController implements Initializable {
    ...
    @FXML ImageView bookingPageLogo;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        bookingPageLogo.setImage(logoImg);
    ...
    public void showBookings(ActionEvent event) throws IOException, SQLException {
        ...
        String query = "SELECT date, timePeriod, numberOfGuests, approved, bookingID FROM booking WHERE customerID = ? ";
