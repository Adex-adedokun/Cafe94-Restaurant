...
public class Item<SimpleDoublePropertyrice> {
     ...
     */
    public Item(SimpleIntegerProperty id, SimpleStringProperty itemName, SimpleDoubleProperty price,
                SimpleBooleanProperty isDailySpecial, SimpleStringProperty type) {
        this.id = id;
